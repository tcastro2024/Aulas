...
{
    class DomainExceptionIntCode : ApplicationException
    {
        ...
        public DomainExceptionIntCode(string message) : base(message)
        {
        ...
        // como parametro
        public DomainExceptionIntCode(int code) : base(GetMessageFromCode(code))
        {
            Code = code;
        }
